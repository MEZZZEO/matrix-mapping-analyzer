...
- VContainer (DI), UniTask (асинхронность), Newtonsoft.Json
- TextMeshPro (UI)
...
- Визуализация результатов:
  - Пул объектов (generic, SOLID) без GC‑аллокаций
...
2) Откройте сцену или быстро соберите сцену по гайду:
   - `QUICK_SETUP_GUIDE.md` — быстрый старт (10 минут)
   - `SCENE_STRUCTURE.md` — эталонная структура сцены
